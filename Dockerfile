...
ENV RSEM_RELEASE=1.2.25
#ENV RSEM_URL=https://github.com/deweylab/RSEM/archive/v${RSEM_RELEASE}.tar.gz
ENV RSEM_URL=https://github.com/deweylab/RSEM/releases/v${RSEM_RELEASE}.tar.gz
ENV DEST_DIR=/opt
